                            ...
                            <div class="col col-lg-4  col-md-4 col-sm-6">
                                <div class="widget market-widget wpo-service-link-widget">
                                    ...
                                    <div class="contact-ft">
                                        <ul>
                                            <li><i class="fi flaticon-pin"></i>Jaipur</li>
                                            <li><i class="fi flaticon-call"></i>+91000000</li>
                                            <li><i class="fi flaticon-envelope"></i>mail@gmail.com</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col col-xs-12">
                                <p class="copyright">&copy; 2020 Caring Together. All rights reserved</p>
                            </div>
                        </div>
                    </div>
                </div>
